...
INSERT INTO roles(role_id, role_name, id) VALUES
                                                   (101, 'USER', 1),
                                                   (102, 'ADMIN', 2);
...
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'USD', 1000.00, (SELECT id FROM customers WHERE name = 'John Doe'), 1, 1);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'EUR', 500.00, (SELECT id FROM customers WHERE name = 'John Doe'), 1, 2);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'USD', 2000.00, (SELECT id FROM customers WHERE name = 'Jane Smith'), 2, 2);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'EUR', 1500.00, (SELECT id FROM customers WHERE name = 'Michael Johnson'), 1, 1);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'USD', 1000.00, (SELECT id FROM customers WHERE name = 'Sarah Brown'), 1, 2);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'EUR', 500.00, (SELECT id FROM customers WHERE name = 'Chris Wilson'), 2, 2);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'USD', 2000.00, (SELECT id FROM customers WHERE name = 'Emma Lee'), 1, 1);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'EUR', 1500.00, (SELECT id FROM customers WHERE name = 'David Taylor'), 1, 2);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'USD', 1000.00, (SELECT id FROM customers WHERE name = 'Olivia Anderson'), 2, 2);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'EUR', 500.00, (SELECT id FROM customers WHERE name = 'William Martinez'), 1, 1);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'USD', 2000.00, (SELECT id FROM customers WHERE name = 'Sophia Hernandez'), 1, 2);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'EUR', 1500.00, (SELECT id FROM customers WHERE name = 'Daniel Thompson'), 2, 2);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'USD', 1000.00, (SELECT id FROM customers WHERE name = 'Ava Gonzalez'), 1, 1);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'EUR', 500.00, (SELECT id FROM customers WHERE name = 'James Perez'), 1, 2);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'USD', 2000.00, (SELECT id FROM customers WHERE name = 'Isabella Roberts'), 2, 2);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'EUR', 1500.00, (SELECT id FROM customers WHERE name = 'Joseph Walker'), 1, 1);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'USD', 1000.00, (SELECT id FROM customers WHERE name = 'Mia Hall'), 1, 2);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'EUR', 500.00, (SELECT id FROM customers WHERE name = 'Alexander Young'), 2, 2);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'USD', 2000.00, (SELECT id FROM customers WHERE name = 'Charlotte King'), 1, 1);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'EUR', 1500.00, (SELECT id FROM customers WHERE name = 'Ethan Scott'), 1, 2);
INSERT INTO accounts (number, currency, balance, customer_id, created_by, last_modified_by) VALUES (UUID(), 'USD', 1000.00, (SELECT id FROM customers WHERE name = 'Emily Adams'), 2, 2);
